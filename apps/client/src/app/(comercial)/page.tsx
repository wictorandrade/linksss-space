...
export const metadata: Metadata = {
  title: 'Linksss | Sua Bio em Um Só Lugar',
  description:
    'Links, conteúdo pago e analytics completo. Crie sua página de bio profissional em minutos. Feito por Souzs.',
}
...
const features = [
  ...
  },
  {
    ...
    description: 'Templates únicos e artísticos para sua página se destacar.',
  },
  {
    icon: BarChart3,
...
export default function HomePage() {
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Top glow */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_-10%,rgba(99,102,241,0.15),transparent)] pointer-events-none" />
      ...
      <section className="relative container px-4 pt-32 pb-20 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto mt-16">
          {[
            { value: '7', label: 'Templates premium' },
            { value: '3', label: 'Planos flexíveis' },
      ...
      <section id="pricing" className="relative container px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {plans.map((plan) => (
            ...
            >
              ...
              <Link href={plan.featured ? '/pricing' : '/dashboard'}>
                <Button
                  className="w-full"
        ...
        <div className="text-center mt-8">
          <Link href="/pricing" className="text-primary-500 hover:underline text-sm">
